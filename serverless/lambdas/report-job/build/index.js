...
var handler = function (event, _) { return __awaiter(void 0, void 0, void 0, function () {
    var rdsSecret, documentDbSecret, rdsClient, s3, params, Body, certFilePath, writeFileAsync, mongoConnectionString, docuemtnDBClient, db, collection, _i, _a, row, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                ...
                docuemtnDBClient = new mongodb_1.MongoClient(mongoConnectionString, {
                    tls: true,
            ...
            case 11:
                _i++;
                return [3 /*break*/, 9];
            case 12: return [2 /*return*/, { statusCode: 200, body: "Data saved successfully." }];
            case 13:
                error_1 = _b.sent();
                console.error("Failed to update Order:", error_1);
                throw error_1;
            case 14: return [4 /*yield*/, rdsClient.end()];
            case 15:
                _b.sent();
                return [7 /*endfinally*/];
