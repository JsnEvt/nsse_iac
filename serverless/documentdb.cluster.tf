resource "aws_docdb_cluster" "this" {
  ...
  master_password                 = jsonencode(aws_secretmanager_secret_version.first.secret_string)["password"]
...
//O programa Studio 3T free for MongoDB serve para realizar a conexao via tunel
